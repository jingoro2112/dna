...
// Dialog Data
	...
	static CMorlockDlg *m_singleton;
...
protected:
	...
	void save();
	unsigned int getJsonValue( const char* value, JsonValue &stream );
	void load( Cstr& buf );
...
public:
	...
	afx_msg void OnDeltaposEyeDetectSpin(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnDeltaposShortCyclePreventSpin(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnDeltaposEyeDetectHoldoffSpin2(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnBnClickedAutoApply();
	afx_msg void OnBnClickedEyeStrong();
	afx_msg void OnBnClickedEyeWeak();
};
