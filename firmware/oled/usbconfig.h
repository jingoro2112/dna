 ...
 */
#define USB_CFG_VENDOR_NAME     'o','l','e', 'd', '@','n','o','r','t','h','a','r','c','.','c','o','m'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'O','L','E','D'
 ...
 */
#define USB_CFG_INTERFACE_CLASS     3 //HID 0   /* define class here if not at device level */
