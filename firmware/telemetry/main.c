...
void compute( int cycles )
{
	...
	for( int y=0; y<cycles; y++ )
	{
		...
		switch( rand() % 6 )
		{
			case 0: intensity[G1] = 0xFF; break;
			case 1: intensity[G2] = 0xFF; break;
			case 2: intensity[G3] = 0xFF; break;
			case 3: intensity[G4] = 0xFF; break;
			case 4: intensity[Y1] = 0xFF; break;
			case 5: intensity[Y2] = 0xFF; break;
		}
		*/
