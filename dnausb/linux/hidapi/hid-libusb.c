...
// this is a buggy mess. I commented out all the stuff the DNA
// sdk doesn't use
...
int HID_API_EXPORT_CALL hid_get_serial_number_string(hid_device *dev, char *string, size_t maxlen)
{
	return hid_get_indexed_string(dev, dev->serial_index, string, maxlen);
}

int HID_API_EXPORT_CALL hid_get_indexed_string(hid_device *dev, int string_index, char *string, size_t maxlen)
{
	wchar_t *str;
